...
const data = [
  {
    image:
      "https://drive.google.com/uc?export=view&id=14W92RuywPYQQoI6-EJewMG1D3VkuZRYK",
    name: "Track",
    info: "An expense tracking app, secure login with webtokens, and secure signups with bcryptjs",
    stacks:
      "React.js, axios, redux, react-router-dom, Node, MongoDB, Mongoose, sass, redux,  Express, bcryptjs, jsonwebtoken ",
  ...
  {
    image:
      "https://drive.google.com/uc?export=view&id=1FIHThIZjdzQRZitIrMx_m3gl0biem1wr",
    name: "Journey",
  ...
  {
    image:
      "https://drive.google.com/uc?export=view&id=1XVZuVSQiuELjCXNU3CxDGh2Xcvkz6rNh",
    name: "DogPool",
